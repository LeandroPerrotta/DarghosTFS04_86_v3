...
trade_lists = {
	...
	["armors"] = {
		...
		{ name = "spirit cloak", sell_for = 1000 },
	...
	["djinn_alessar"] = {
		...
		{ name = "giant sword", buy_for = 25500 },
		{ name = "knight axe", buy_for = 3000 },
		{ name = "serpent sword", buy_for = 1350 },
		{ name = "skull staff", buy_for = 9000 },
		{ name = "knight armor", buy_for = 7500 },
		{ name = "warrior helmet", buy_for = 7500 },
		{ name = "knight legs", buy_for = 7500 },
		{ name = "black shield", buy_for = 1200 },
		{ name = "tower shield", buy_for = 12000 },
		{ name = "vampire shield", buy_for = 22500 },
	},
	...
	["djinn_nah"] = {
		{ name = "beholder shield", sell_for = 7000 },
		{ name = "noble armor", sell_for = 8000 },
		{ name = "spike sword", sell_for = 7000, buy_for = 1500 },
		{ name = "war hammer", sell_for = 10000, buy_for = 1800 },
		
		{ name = "crown shield", buy_for = 12000 },
		{ name = "dragon shield", buy_for = 6000 },
		{ name = "guardian shield", buy_for = 3000 },
		{ name = "phoenix shield", buy_for = 24000 },
		{ name = "blue robe", buy_for = 15000 },
		{ name = "crown armor", buy_for = 18000 },
		{ name = "boots of haste", buy_for = 45000 },
		{ name = "dragon lance", buy_for = 13500 },
		{ name = "fire axe", buy_for = 12000 },
		{ name = "fire sword", buy_for = 6000 },
		{ name = "ice rapier", buy_for = 1500 },
		{ name = "obsidian lance", buy_for = 750 },
		{ name = "crown helmet", buy_for = 3750 },
		{ name = "crusader helmet", buy_for = 13500 },
		{ name = "royal helmet", buy_for = 45000 },
		{ name = "crown legs", buy_for = 18000 },
	},
	...
	["rashid"] = {	
		...
		{ name = "amber staff", buy_for = 12000 },	
