...
EquipmentDurabilityMap_t Items::helmetsDurability;
EquipmentDurabilityMap_t Items::chestsDurability;
EquipmentDurabilityMap_t Items::legsDurability;
EquipmentDurabilityMap_t Items::feetsDurability;

DurabilityMap_t Items::distanceDurability;
DurabilityMap_t Items::lightItemsDurability;
DurabilityMap_t Items::mediumItemsDurability;
DurabilityMap_t Items::heavyItemsDurability;
...
ItemType::ItemType()
{
	...
	m_criticalChance = 0;
	m_rarity = ITEM_RARITY_NONE;
	m_quality = ITEM_QUALITY_NONE;
	m_maxDurability = m_durability = -1;
#endif
...
#ifdef __DARGHOS_CUSTOM__
	//cloth's
	Items::helmetsDurability[ITEM_RARITY_COMMON][ITEM_QUALITY_CLOTH] = 45;
	Items::chestsDurability[ITEM_RARITY_COMMON][ITEM_QUALITY_CLOTH] = 70;
	Items::legsDurability[ITEM_RARITY_COMMON][ITEM_QUALITY_CLOTH] = 55;
	Items::feetsDurability[ITEM_RARITY_COMMON][ITEM_QUALITY_CLOTH] = 35;

	Items::helmetsDurability[ITEM_RARITY_RARE][ITEM_QUALITY_CLOTH] = 50;
	Items::chestsDurability[ITEM_RARITY_RARE][ITEM_QUALITY_CLOTH] = 80;
	Items::legsDurability[ITEM_RARITY_RARE][ITEM_QUALITY_CLOTH] = 65;
	Items::feetsDurability[ITEM_RARITY_RARE][ITEM_QUALITY_CLOTH] = 40;

	Items::helmetsDurability[ITEM_RARITY_EPIC][ITEM_QUALITY_CLOTH] = 60;
	Items::chestsDurability[ITEM_RARITY_EPIC][ITEM_QUALITY_CLOTH] = 100;
	Items::legsDurability[ITEM_RARITY_EPIC][ITEM_QUALITY_CLOTH] = 75;
	Items::feetsDurability[ITEM_RARITY_EPIC][ITEM_QUALITY_CLOTH] = 50;

	Items::helmetsDurability[ITEM_RARITY_LEGENDARY][ITEM_QUALITY_CLOTH] = 70;
	Items::chestsDurability[ITEM_RARITY_LEGENDARY][ITEM_QUALITY_CLOTH] = 120;
	Items::legsDurability[ITEM_RARITY_LEGENDARY][ITEM_QUALITY_CLOTH] = 90;
	Items::feetsDurability[ITEM_RARITY_LEGENDARY][ITEM_QUALITY_CLOTH] = 60;

	//leathers's
	Items::helmetsDurability[ITEM_RARITY_COMMON][ITEM_QUALITY_LEATHER] = 50;
	Items::chestsDurability[ITEM_RARITY_COMMON][ITEM_QUALITY_LEATHER] = 85;
	Items::legsDurability[ITEM_RARITY_COMMON][ITEM_QUALITY_LEATHER] = 65;
	Items::feetsDurability[ITEM_RARITY_COMMON][ITEM_QUALITY_LEATHER] = 45;

	Items::helmetsDurability[ITEM_RARITY_RARE][ITEM_QUALITY_LEATHER] = 60;
	Items::chestsDurability[ITEM_RARITY_RARE][ITEM_QUALITY_LEATHER] = 100;
	Items::legsDurability[ITEM_RARITY_RARE][ITEM_QUALITY_LEATHER] = 75;
	Items::feetsDurability[ITEM_RARITY_RARE][ITEM_QUALITY_LEATHER] = 50;

	Items::helmetsDurability[ITEM_RARITY_EPIC][ITEM_QUALITY_LEATHER] = 70;
	Items::chestsDurability[ITEM_RARITY_EPIC][ITEM_QUALITY_LEATHER] = 120;
	Items::legsDurability[ITEM_RARITY_EPIC][ITEM_QUALITY_LEATHER] = 90;
	Items::feetsDurability[ITEM_RARITY_EPIC][ITEM_QUALITY_LEATHER] = 60;

	Items::helmetsDurability[ITEM_RARITY_LEGENDARY][ITEM_QUALITY_LEATHER] = 85;
	Items::chestsDurability[ITEM_RARITY_LEGENDARY][ITEM_QUALITY_LEATHER] = 145;
	Items::legsDurability[ITEM_RARITY_LEGENDARY][ITEM_QUALITY_LEATHER] = 110;
	Items::feetsDurability[ITEM_RARITY_LEGENDARY][ITEM_QUALITY_LEATHER] = 70;

	//mail's
	Items::helmetsDurability[ITEM_RARITY_COMMON][ITEM_QUALITY_MAIL] = 60;
	Items::chestsDurability[ITEM_RARITY_COMMON][ITEM_QUALITY_MAIL] = 100;
	Items::legsDurability[ITEM_RARITY_COMMON][ITEM_QUALITY_MAIL] = 75;
	Items::feetsDurability[ITEM_RARITY_COMMON][ITEM_QUALITY_MAIL] = 50;

	Items::helmetsDurability[ITEM_RARITY_RARE][ITEM_QUALITY_MAIL] = 70;
	Items::chestsDurability[ITEM_RARITY_RARE][ITEM_QUALITY_MAIL] = 120;
	Items::legsDurability[ITEM_RARITY_RARE][ITEM_QUALITY_MAIL] = 90;
	Items::feetsDurability[ITEM_RARITY_RARE][ITEM_QUALITY_MAIL] = 60;

	Items::helmetsDurability[ITEM_RARITY_EPIC][ITEM_QUALITY_MAIL] = 85;
	Items::chestsDurability[ITEM_RARITY_EPIC][ITEM_QUALITY_MAIL] = 140;
	Items::legsDurability[ITEM_RARITY_EPIC][ITEM_QUALITY_MAIL] = 105;
	Items::feetsDurability[ITEM_RARITY_EPIC][ITEM_QUALITY_MAIL] = 70;

	Items::helmetsDurability[ITEM_RARITY_LEGENDARY][ITEM_QUALITY_MAIL] = 100;
	Items::chestsDurability[ITEM_RARITY_LEGENDARY][ITEM_QUALITY_MAIL] = 170;
	Items::legsDurability[ITEM_RARITY_LEGENDARY][ITEM_QUALITY_MAIL] = 130;
	Items::feetsDurability[ITEM_RARITY_LEGENDARY][ITEM_QUALITY_MAIL] = 85;

	//plate's
	Items::helmetsDurability[ITEM_RARITY_COMMON][ITEM_QUALITY_PLATE] = 70;
	Items::chestsDurability[ITEM_RARITY_COMMON][ITEM_QUALITY_PLATE] = 115;
	Items::legsDurability[ITEM_RARITY_COMMON][ITEM_QUALITY_PLATE] = 85;
	Items::feetsDurability[ITEM_RARITY_COMMON][ITEM_QUALITY_PLATE] = 55;

	Items::helmetsDurability[ITEM_RARITY_RARE][ITEM_QUALITY_PLATE] = 80;
	Items::chestsDurability[ITEM_RARITY_RARE][ITEM_QUALITY_PLATE] = 135;
	Items::legsDurability[ITEM_RARITY_RARE][ITEM_QUALITY_PLATE] = 100;
	Items::feetsDurability[ITEM_RARITY_RARE][ITEM_QUALITY_PLATE] = 65;

	Items::helmetsDurability[ITEM_RARITY_EPIC][ITEM_QUALITY_PLATE] = 100;
	Items::chestsDurability[ITEM_RARITY_EPIC][ITEM_QUALITY_PLATE] = 165;
	Items::legsDurability[ITEM_RARITY_EPIC][ITEM_QUALITY_PLATE] = 120;
	Items::feetsDurability[ITEM_RARITY_EPIC][ITEM_QUALITY_PLATE] = 75;

	Items::helmetsDurability[ITEM_RARITY_LEGENDARY][ITEM_QUALITY_PLATE] = 115;
	Items::chestsDurability[ITEM_RARITY_LEGENDARY][ITEM_QUALITY_PLATE] = 195;
	Items::legsDurability[ITEM_RARITY_LEGENDARY][ITEM_QUALITY_PLATE] = 145;
	Items::feetsDurability[ITEM_RARITY_LEGENDARY][ITEM_QUALITY_PLATE] = 95;

	//distance weapons durability
	Items::distanceDurability[ITEM_RARITY_COMMON] = 65;
	Items::distanceDurability[ITEM_RARITY_RARE] = 75;
	Items::distanceDurability[ITEM_RARITY_EPIC] = 90;
	Items::distanceDurability[ITEM_RARITY_LEGENDARY] = 110;

	//light handed items durability (wands, rods, etc...)
	Items::lightItemsDurability[ITEM_RARITY_COMMON] = 55;
	Items::lightItemsDurability[ITEM_RARITY_RARE] = 65;
	Items::lightItemsDurability[ITEM_RARITY_EPIC] = 75;
	Items::lightItemsDurability[ITEM_RARITY_LEGENDARY] = 90;

	//medium handed items durability (1hand weapons, etc...)
	Items::mediumItemsDurability[ITEM_RARITY_COMMON] = 75;
	Items::mediumItemsDurability[ITEM_RARITY_RARE] = 90;
	Items::mediumItemsDurability[ITEM_RARITY_EPIC] = 105;
	Items::mediumItemsDurability[ITEM_RARITY_LEGENDARY] = 125;

	//heavy handed items durability (2hand weapons, shields, etc...)
	Items::heavyItemsDurability[ITEM_RARITY_COMMON] = 85;
	Items::heavyItemsDurability[ITEM_RARITY_RARE] = 100;
	Items::heavyItemsDurability[ITEM_RARITY_EPIC] = 120;
	Items::heavyItemsDurability[ITEM_RARITY_LEGENDARY] = 145;
#endif
	...
	while(itemAttributesNode)
	{
		...
		else if(tmpStrValue == "rarity")
		{
			if(readXMLString(itemAttributesNode, "value", strValue))
			{
				...
				{
					it.m_rarity = ITEM_RARITY_COMMON;
				}
				else if(tmpStrValue == "rare")
				{
					it.m_rarity = ITEM_RARITY_RARE;
				}
				else if(tmpStrValue == "epic")
				{
					it.m_rarity = ITEM_RARITY_EPIC;
				}
				else if(tmpStrValue == "legendary")
				{
					it.m_rarity = ITEM_RARITY_LEGENDARY;
				}
				else
					std::clog << "[Warning - Items::loadFromXml] Unknown rarity type " << strValue << std::endl;
			}
		}
		else if(tmpStrValue == "quality")
		{
			if(readXMLString(itemAttributesNode, "value", strValue))
			{
				tmpStrValue = asLowerCaseString(strValue);
			
				if(tmpStrValue == "cloth")
				{
					it.m_quality = ITEM_QUALITY_CLOTH;
				}
				else if(tmpStrValue == "leather")
				{
					it.m_quality = ITEM_QUALITY_LEATHER;
				}
				else if(tmpStrValue == "mail")
				{
					it.m_quality = ITEM_QUALITY_MAIL;
				}
				else if(tmpStrValue == "plate")
				{
					it.m_quality = ITEM_QUALITY_PLATE;
				}
				else
					std::clog << "[Warning - Items::loadFromXml] Unknown quality type " << strValue << std::endl;
			}
		}
#endif
