...
{
	ITEM_QUALITY_NONE = 0,
	ITEM_QUALITY_CLOTH = 1,
	ITEM_QUALITY_LEATHER = 2,
	ITEM_QUALITY_MAIL = 3,
	ITEM_QUALITY_PLATE = 4
};
#endif
...
#ifdef __DARGHOS_CUSTOM__
		int32_t m_criticalChance, m_maxDurability, m_durability;

		ItemRarity_t m_rarity;
...
#ifdef __DARGHOS_CUSTOM__
typedef std::map<ItemRarity_t, std::map<ItemQuality_t, int16_t> > EquipmentDurabilityMap_t;
typedef std::map<ItemRarity_t, int16_t> DurabilityMap_t;
#endif
...
#ifdef __DARGHOS_CUSTOM__
		static EquipmentDurabilityMap_t helmetsDurability, chestsDurability, legsDurability, feetsDurability;
		static DurabilityMap_t distanceDurability, lightItemsDurability, mediumItemsDurability, heavyItemsDurability;
#endif
